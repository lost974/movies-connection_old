...
<table class="profil_middle">
	<tr>
		<td>
		<?php 
		if($user_u == 1)
		{
			echo html::anchor('user/edit_profil/'.$user->username, 'Modifier mon profil');
			//echo '<br />Inscrit depuis : '.gen::time_left($user->created);
		}
		?>
		</td>
	</tr>
	<tr>
		<td><br />Dernières Activités :</td>
	</tr>
	<tr>
		<td>
			<table id="profil_wall">
				<?php 
				foreach($events as $e)
				{
...
<table class="profil_right">
	...
	<tr>
		...
		if(count($marks5) != 0)
		{
			...
			echo $movie->profil_movie_plus($user->username);
